...
write_parquet(price_matrix, file.path("../data", "15_asset_prices.parquet"))
write_parquet(returns_matrix, file.path("../data", "15_asset_returns.parquet"))

# Option B: Save as CSV (Good to have for quick viewing in Excel/Numbers)
write_csv(price_matrix, file.path("../data", "15_asset_prices.csv"))
write_csv(returns_matrix, file.path("../data", "15_asset_returns.csv"))
